...
import { AlertMedium as IconComponent } from '@adobe/react-spectrum-ui/dist/AlertMedium.js';
...
export default function AlertMedium(props) {
  ...
  return /*#__PURE__*/React.createElement(UIIcon, props, provider != null && (_provider$theme = provider.theme) != null && (_provider$theme = _provider$theme.global) != null && _provider$theme.express ? /*#__PURE__*/React.createElement(ExpressIcon, null) : /*#__PURE__*/React.createElement(IconComponent, null));
}